...
This guide provides comprehensive steps to configure Tyk API Gateway OSS with Jaeger, enabling efficient distributed tracing and amplifying API observability.
...
1. Install from the cert-manager release manifest (required by Jaeger)
