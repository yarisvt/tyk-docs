...
<<<<<<< HEAD:tyk-docs/content/release-notes/version-4.3.md
...
=======
#### Mock Responses with Tyk OAS API Definitions
>>>>>>> 65fa6686... [Dx 902] Remove H1 headings from GW Release Notes < 5.x (#3740):tyk-docs/content/product-stack/tyk-gateway/release-notes/version-4.3.md
