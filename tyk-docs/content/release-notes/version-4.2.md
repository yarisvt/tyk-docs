...
<<<<<<< HEAD:tyk-docs/content/release-notes/version-4.2.md
## Tyk Dashboard
### Added
- Added support for Kafka as a data source in Universal Data Graph.
...
=======
## Updated Versions
>>>>>>> 65fa6686... [Dx 902] Remove H1 headings from GW Release Notes < 5.x (#3740):tyk-docs/content/product-stack/tyk-gateway/release-notes/version-4.2.md
Tyk Gateway 4.2
Tyk Dashboard 4.2
