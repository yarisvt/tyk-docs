...
2. For the **MDCB-INGRESS**, choose the correct deployment and copy the MDCB URL.

3. We need an **ORG ID** and **API key** from the Tyk Cloud account.

4. Launch the API Manager Dashboard.
