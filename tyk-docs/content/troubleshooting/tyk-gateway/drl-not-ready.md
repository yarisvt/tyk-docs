...
There can be a couple of reasons for seeing this error about the [Distributed Rate Limiter](https://tyk.io/docs/control-limit-traffic/rate-limiting/#distributed-rate-limiter-drl):
