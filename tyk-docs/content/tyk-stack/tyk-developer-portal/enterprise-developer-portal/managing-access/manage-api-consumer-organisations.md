...
Please refer to [the email notification section]({{< ref "/product-stack/tyk-enterprise-developer-portal/getting-started/setup-email-notifications" >}}) for further instructions for setting up email server.
