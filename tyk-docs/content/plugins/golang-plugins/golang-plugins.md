...
```
Exlanation to the command above: 
1. Mount your plugin directory to `/go/src/plugin-build` image location
2. Make sure to Specify your Tyk version via a Docker tag. In the time of writig this doc it's `v2.9.3` . 
