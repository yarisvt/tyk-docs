...
Since Tyk 2.10 we have incorporated response hooks, this type of hook allows you to modify the response object before its being sent to the client. The flow is follows:
