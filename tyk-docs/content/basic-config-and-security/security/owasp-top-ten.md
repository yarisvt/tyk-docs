...
- [OpenTracing]({{< ref "advanced-configuration/distributed-tracing/opentracing/opentracing" >}}) to allow services, which have distributed tracing enabled, for instrumentation to work seamless with Tyk gateway.
