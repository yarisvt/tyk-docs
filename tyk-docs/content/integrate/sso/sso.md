...
See our [TIB detailed overview](/docs/integrate/3rd-party-identity-providers/#a-name-tib-a-tyk-identity-broker-tib-overview) for further information.
...
See [using a Social Identity Provider](/docs/integrate/3rd-party-identity-providers/social/) for details of using SSO with Social Identity Providers.
Instructions on setting SSO with Google+ will be added soon.

### <a name="openid-connect"></a> SSO with OpenID Connect (OIDC)
- Instruction on setting [SSO with Okta](/docs/integrate/sso/dashboard-login-okta-tib/)
