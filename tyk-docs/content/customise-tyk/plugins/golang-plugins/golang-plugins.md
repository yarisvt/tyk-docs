...
* in the `"post"` section - the field `"path"` full or relative (to the Tyk binary) path to `.so` file with plugin implementation (make sure Tyk has read access to this file)
