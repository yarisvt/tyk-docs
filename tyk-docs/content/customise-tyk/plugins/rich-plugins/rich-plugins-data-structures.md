...
> **NOTE**: Although `apply_policy_id` is still supported, it is now deprecated. `apply_policies` is now used to list your policy IDs as an array. This supports the **[Multiple Policy](https://tyk.io/docs/security/security-policies/partitioned-policies/#multiple)** feature introduced in the  **v2.4 - 1.4** release.
