...
python3 scripts/menu_generator.py ~/Downloads/Doc-pages-navigation-update-data-bank.csv  ~/Downloads/Doc-pages-navigation-update-pages-list.csv ./tyk-docs/public/urlcheck.json check-pages
